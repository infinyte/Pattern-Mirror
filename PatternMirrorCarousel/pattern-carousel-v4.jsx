...
function Diagram04() {
  return (
    <svg viewBox="0 0 480 220" width="100%" height="100%">
      <defs>
        <path id="p04a" d="M95,70  L195,70" />
        <path id="p04b" d="M275,70 L375,70" />
      </defs>

      <text x={240} y={25} textAnchor="middle" fill="#67e8f9" fontSize={11}
        fontFamily="'Source Code Pro', monospace" fontWeight="600" opacity="0.7">
        Orchestrator manages state across steps
      </text>
      ...
      <text x={240} y={115} textAnchor="middle" fill="#9ca3af" fontSize={10}
        fontFamily="'Source Code Pro', monospace">state: idle → running → complete</text>

      <rect x={140} y={130} width={200} height={50} rx={8}
        fill="#0077a8" opacity="0.15" stroke="#0077a8" strokeWidth="1.5" strokeDasharray="4,3" />
      <text x={240} y={155} textAnchor="middle" fill="#67e8f9" fontSize={12}
        fontFamily="'Source Sans 3', sans-serif" fontWeight="600">State Machine</text>
      <text x={240} y={170} textAnchor="middle" fill="#67e8f980" fontSize={10}
        fontFamily="'Source Code Pro', monospace">tracks + retries</text>
      ...
      <AnimDot id="p04a" color="#22d3ee" dur="2s" begin="0s" />
      <AnimDot id="p04b" color="#22d3ee" dur="2s" begin="1s" />
    </svg>
  );
}
...
function Diagram05() {
  return (
    <svg viewBox="0 0 480 220" width="100%" height="100%">
      <defs>
        <path id="p05fwd" d="M50,55  L155,55 L260,55 L370,55" />
        <path id="p05rev" d="M370,165 L260,165 L155,165 L50,165" />
      </defs>

      <text x={240} y={25} textAnchor="middle" fill="#fca5a5" fontSize={11}
        fontFamily="'Source Code Pro', monospace" fontWeight="600" opacity="0.7">
        Forward steps → then compensate on failure ←
      </text>
      ...
      <rect x={345} y={35} width={70} height={40} rx={8}
        fill="#ef444420" stroke="#ef4444" strokeWidth="1.5" />
      <text x={380} y={55} textAnchor="middle" dominantBaseline="central"
        fill="#ef4444" fontSize={11} fontFamily="'Source Sans 3', sans-serif" fontWeight="700">
        FAIL ✕
      </text>
      ...
      <AnimDot id="p05fwd" color="#34d399" dur="3s"   begin="0s" />
      <AnimDot id="p05rev" color="#f87171" dur="3s"   begin="1.5s" />
    </svg>
  );
}
...
function Diagram06() {
  return (
    <svg viewBox="0 0 480 220" width="100%" height="100%">
      ...
      {/* Legacy system — dimmed, dashed border */}
      ...
      {/* Animated traffic: 2 requests in → 1 to legacy, 3 to new */}
...
function Diagram07() {
  return (
    <svg viewBox="0 0 480 220" width="100%" height="100%">
      <defs>
        <path id="p07loop" d="M150,110 C150,40 330,40 330,110 C330,180 150,180 150,110" />
      </defs>

      {/* CLOSED state */}
      <rect x={65}  y={55} width={100} height={50} rx={25}
        fill="#22c55e20" stroke="#22c55e" strokeWidth="2" />
      <text x={115} y={80}  textAnchor="middle" dominantBaseline="central"
        fill="#4ade80" fontSize={13} fontFamily="'Source Sans 3', sans-serif" fontWeight="700">
        CLOSED
      </text>
      <text x={115} y={120} textAnchor="middle"
        fill="#4ade8080" fontSize={10} fontFamily="'Source Code Pro', monospace">
        requests flow
      </text>

      {/* OPEN state */}
      <rect x={190} y={55} width={100} height={50} rx={25}
        fill="#ef444420" stroke="#ef4444" strokeWidth="2" />
      <text x={240} y={80}  textAnchor="middle" dominantBaseline="central"
        fill="#f87171" fontSize={13} fontFamily="'Source Sans 3', sans-serif" fontWeight="700">
        OPEN
      </text>
      <text x={240} y={120} textAnchor="middle"
        fill="#f8717180" fontSize={10} fontFamily="'Source Code Pro', monospace">
        fail fast
      </text>

      {/* HALF-OPEN state */}
      <rect x={315} y={55} width={100} height={50} rx={25}
        fill="#f59e0b20" stroke="#f59e0b" strokeWidth="2" />
      <text x={365} y={80}  textAnchor="middle" dominantBaseline="central"
        fill="#fbbf24" fontSize={12} fontFamily="'Source Sans 3', sans-serif" fontWeight="700">
        HALF-OPEN
      </text>
      <text x={365} y={120} textAnchor="middle"
        fill="#fbbf2480" fontSize={10} fontFamily="'Source Code Pro', monospace">
        test probe
      </text>
      ...
      <text x={178} y={60} textAnchor="middle"
        fill="#9ca3af" fontSize={8} fontFamily="'Source Code Pro', monospace">threshold</text>
      ...
      <text x={303} y={72} textAnchor="middle"
        fill="#9ca3af" fontSize={8} fontFamily="'Source Code Pro', monospace">timeout</text>

      {/* Success → closed arc */}
      <path d="M365,105 C365,175 115,175 115,105"
        stroke="#4ade80" strokeWidth="1" opacity="0.3" fill="none" strokeDasharray="4,3" />
      ...
      {/* Fail → reopen arc */}
      <path d="M365,55 C365,10 240,10 240,55"
        stroke="#f87171" strokeWidth="1" opacity="0.3" fill="none" strokeDasharray="4,3" />
      <text x={303} y={20} textAnchor="middle"
        fill="#f8717180" fontSize={9} fontFamily="'Source Code Pro', monospace">
        fail → reopen
      </text>

      <AnimDot id="p07loop" color="#fbbf24" dur="4s" begin="0s" />
    </svg>
  );
}
...
function Diagram08() {
  return (
    <svg viewBox="0 0 480 220" width="100%" height="100%">
      <defs>
        <path id="p08hit"  d="M105,80  L220,80" />
        <path id="p08miss" d="M105,170 L220,170" />
        <path id="p08db"   d="M320,170 L420,170" />
        <path id="p08fill" d="M420,155 C440,120 350,80 320,80" />
      </defs>

      <Box x={15}  y={55} w={90} h={50} text="App Request" color="#60a5fa" fontSize={12} />

      <rect x={220} y={50} width={100} height={60} rx={10}
        fill="#3a7d44" opacity="0.2" stroke="#3a7d44" strokeWidth="2" />
      <text x={270} y={77}  textAnchor="middle" fill="#4ade80" fontSize={13}
        fontFamily="'Source Sans 3', sans-serif" fontWeight="700">Cache</text>
      <text x={270} y={95}  textAnchor="middle" fill="#4ade8080" fontSize={10}
        fontFamily="'Source Code Pro', monospace">Redis / Memory</text>

      <text x={170} y={70}  textAnchor="middle" fill="#4ade80" fontSize={11}
        fontFamily="'Source Code Pro', monospace" fontWeight="600">HIT ✓</text>
      ...
      <text x={170} y={160} textAnchor="middle" fill="#f87171" fontSize={11}
        fontFamily="'Source Code Pro', monospace" fontWeight="600">MISS ✕</text>
      <line x1="105" y1="170" x2="220" y2="170"
        stroke="#f87171" strokeWidth="1" opacity="0.3" strokeDasharray="5,3" />
      ...
      <rect x={410} y={140} width={60} height={55} rx={8}
        fill="#60a5fa" opacity="0.1" stroke="#60a5fa" strokeWidth="1.5" />
      <text x={440} y={165} textAnchor="middle"
        fill="#60a5fa" fontSize={11} fontFamily="'Source Sans 3', sans-serif" fontWeight="600">DB</text>
      <text x={440} y={180} textAnchor="middle"
        fill="#60a5fa80" fontSize={9} fontFamily="'Source Code Pro', monospace">source</text>

      <path d="M420,140 C430,110 340,80 320,80"
        stroke="#fbbf24" strokeWidth="1" opacity="0.3" fill="none" strokeDasharray="4,3" />
      <text x={385} y={105} textAnchor="middle"
        fill="#fbbf2480" fontSize={9} fontFamily="'Source Code Pro', monospace">fill cache</text>

      <AnimDot id="p08hit"  color="#4ade80" dur="2s"   begin="0s" />
      <AnimDot id="p08miss" color="#f87171" dur="2s"   begin="1s" />
      <AnimDot id="p08db"   color="#f87171" dur="1.5s" begin="2s" />
      <AnimDot id="p08fill" color="#fbbf24" dur="1.5s" begin="2.5s" />
    </svg>
  );
}
...
function Diagram10() {
  ...
  return (
    <svg viewBox="0 0 480 220" width="100%" height="100%">
      <defs>
        <path id="p10ring"
          d={`M${cx + ringR},${cy} A${ringR},${ringR} 0 1,1 ${cx + ringR - 0.01},${cy + 0.01}`} />
      </defs>
        ...
        return (
          <g key={i}>
            ...
            <text x={nx} y={ny + 4} textAnchor="middle"
              fill="#f9a8d4" fontSize={11} fontFamily="'Source Code Pro', monospace" fontWeight="600">
              {nodeLabels[i]}
            </text>
          </g>
        );
      ...
      <text x={80} y={50} fill="#9ca3af" fontSize={10}
        fontFamily="'Source Code Pro', monospace" opacity="0.7">key → hash →</text>
      <text x={80} y={65} fill="#9ca3af" fontSize={10}
        fontFamily="'Source Code Pro', monospace" opacity="0.7">nearest node</text>

      <line x1="130" y1="55"
        x2={cx + ringR * Math.cos((-90) * Math.PI / 180) - 16}
        y2={cy + ringR * Math.sin((-90) * Math.PI / 180)}
        stroke="#f9a8d4" strokeWidth="1" opacity="0.3" strokeDasharray="4,3" />

      <AnimDot id="p10ring" color="#f9a8d4" dur="5s" begin="0s" />
    </svg>
  );
}
...
function Diagram12() {
  return (
    <svg viewBox="0 0 480 220" width="100%" height="100%">
      <defs>
        <path id="p12a" d="M95,60  L385,60" />
        <path id="p12b" d="M385,100 L95,100" />
        <path id="p12s" d="M95,175  L385,175" />
      </defs>

      <rect x={20}  y={30} width={75} height={60} rx={10} fill="#60a5fa15" stroke="#60a5fa" strokeWidth="1.5" />
      <text x={58}  y={55} textAnchor="middle" fill="#93c5fd" fontSize={13}
        fontFamily="'Source Sans 3', sans-serif" fontWeight="700">Alice</text>
      <text x={58}  y={72} textAnchor="middle" fill="#93c5fd80" fontSize={10}
      ...
      <text x={423} y={55} textAnchor="middle" fill="#6ee7b7" fontSize={13}
        fontFamily="'Source Sans 3', sans-serif" fontWeight="700">Bob</text>
      <text x={423} y={72} textAnchor="middle" fill="#6ee7b780" fontSize={10}
        fontFamily="'Source Code Pro', monospace">secret: b</text>

      <line x1="95"  y1="60"  x2="385" y2="60"  stroke="#93c5fd" strokeWidth="1" opacity="0.3" />
      <text x={240} y={52}  textAnchor="middle" fill="#93c5fd" fontSize={10}
        fontFamily="'Source Code Pro', monospace" fontWeight="500">g^a mod p →</text>

      <line x1="385" y1="100" x2="95"  y2="100" stroke="#6ee7b7" strokeWidth="1" opacity="0.3" />
      <text x={240} y={92}  textAnchor="middle" fill="#6ee7b7" fontSize={10}
        fontFamily="'Source Code Pro', monospace" fontWeight="500">← g^b mod p</text>

      <text x={240} y={135} textAnchor="middle" fill="#fbbf24" fontSize={11}
        fontFamily="'Source Code Pro', monospace" fontWeight="600">
        Both compute: g^(ab) mod p
      </text>

      <rect x={145} y={155} width={190} height={40} rx={8}
        fill="#f59e0b15" stroke="#f59e0b" strokeWidth="1.5" />
      <text x={240} y={178} textAnchor="middle" fill="#fbbf24" fontSize={12}
        fontFamily="'Source Sans 3', sans-serif" fontWeight="700">
        🔐 Shared Secret Established
      </text>

      <AnimDot id="p12a" color="#93c5fd" dur="2.5s" begin="0s" />
      <AnimDot id="p12b" color="#6ee7b7" dur="2.5s" begin="1.2s" />
...
function PatternSlide({ slide, index }) {
  ...
  return (
    <div style={{
      ...
      {/* Side-by-side: Infrastructure card ↔ Application card */}
      <div style={{
